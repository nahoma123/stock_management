...
name: odoo-19
description: >-
  Odoo 19 development knowledge base covering modules, manifests, models,
  fields, ORM methods, API decorators, controllers, XML/CSV data, views,
  actions, OWL components, QWeb reports, security, testing, transactions,
  migrations, translations, mixins, and performance. Use when writing,
  reviewing, migrating, optimizing, or debugging Odoo 19 Python, JavaScript,
  XML, or CSV code, and when checking Odoo 19 APIs or framework conventions.
---
